	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            var videoSearch = _lodash2.default.debounce(this.videoSearchFn(term), 300);
	
	            return React.createElement(
	                'div',
	                null,
	                React.createElement(_search_bar2.default, {
	                    onSearchTermChange: this.videoSearchFn(st_term) }),
	                ...
	                React.createElement(_video_list2.default, {
	                    ...
	                    onVideoSelect: this.selectVideoFn(this.state.st_selectedVideo) })
...
//# sourceMappingURL=0.8cac34b90196bafeee04.hot-update.js.map