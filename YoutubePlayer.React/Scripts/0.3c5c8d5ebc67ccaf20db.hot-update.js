	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(_video_details2.default, {
	                    data_video: this.state.st_selectedVideo }),
	                React.createElement(_video_list2.default, {
	                    'data-videos': this.state.st_videos,
	...
	var VideosList = function VideosList(propsObj) {
	    ...
	    return React.createElement(
	        ...
	        dataVideos.map(function (videoDataItem, i) {
	            return React.createElement(_video_list_item2.default, { key: videoDataItem.etag, data_id: i, dataVideos: videoDataItem });
	        })
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VideoListItem = function VideoListItem(propsObj) {
	    ...
	    //destruct propsObj param
	    var data_id = propsObj.data_id,
	        data_video = propsObj.data_video;
	
	    //local vars
	
	    var title = data_video.snippet.title;
	    var imgURL = data_video.snippet.thumbnails.default.url;
...
//# sourceMappingURL=0.3c5c8d5ebc67ccaf20db.hot-update.js.map